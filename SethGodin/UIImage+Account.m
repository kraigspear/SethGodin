    ...
    return [UIImage imageForSize:inSize withDrawingBlock:^
            {
                ...
                [buttonTextContent drawInRect: buttonTextRect withFont: [UIFont fontWithName: @"HelveticaNeue-CondensedBlack" size: 20] lineBreakMode: NSLineBreakByWordWrapping alignment: NSTextAlignmentCenter];
...
+ (UIImage*) backgroundImageForUserSignedIn:(NSString*) signedIn atOrientation:(UIInterfaceOrientation) orientation
{
    if(IS_IPAD)
    {
        return [UIImage backgroundImageiPadForUserSignedIn:signedIn];
    }
    ...
    else
    {
        if(IS_IPHONE5)
        {
            return [UIImage backgroundImage5ForUserSignedLandScape:signedIn atSize:CGSizeMake(568, 320)];
        }
        else
        {
            return [UIImage backgroundImage5ForUserSignedLandScape:signedIn atSize:CGSizeMake(480, 320)];
        }
    }
}

+ (UIImage*) backgroundImage5ForUserSignedLandScape:(NSString*) signedIn atSize:(CGSize) inSize
{
    return [UIImage imageForSize:inSize withDrawingBlock:^
            {
                ...
                CGSize shadowOffset = CGSizeMake(2.1, -6.1);
                ...
                //// Subframes
                CGRect textFrame = CGRectMake(CGRectGetMinX(outerFrame) + floor(CGRectGetWidth(outerFrame) * 0.46924 + 0.5), CGRectGetMinY(outerFrame) + floor((CGRectGetHeight(outerFrame) - 184) * 0.51825 + 0.5), floor(CGRectGetWidth(outerFrame) * 0.89455 + 0.5) - floor(CGRectGetWidth(outerFrame) * 0.46924 + 0.5), 184);
                ...
                NSString* signedInLabelContent = @"SIGNED IN:";
                NSString* signedInTextContent = signedIn;
                
                
                //// outerRect Drawing
                CGRect outerRectRect = CGRectMake(CGRectGetMinX(outerFrame) + floor(CGRectGetWidth(outerFrame) * 0.00176 + 0.5), CGRectGetMinY(outerFrame), floor(CGRectGetWidth(outerFrame) * 1.00000 + 0.5) - floor(CGRectGetWidth(outerFrame) * 0.00176 + 0.5), 320);
                UIBezierPath* outerRectPath = [UIBezierPath bezierPathWithRect: outerRectRect];
                CGContextSaveGState(context);
                [outerRectPath addClip];
                CGContextDrawLinearGradient(context, gradient,
                                            CGPointMake(CGRectGetMidX(outerRectRect), CGRectGetMinY(outerRectRect)),
                                            CGPointMake(CGRectGetMidX(outerRectRect), CGRectGetMaxY(outerRectRect)),
                                            0);
                CGContextRestoreGState(context);
                
                
                //// Rectangle 7 Drawing
                UIBezierPath* rectangle7Path = [UIBezierPath bezierPathWithRect: CGRectMake(CGRectGetMinX(outerFrame) - 57, CGRectGetMinY(outerFrame) - 37, 261, 390)];
                [color setFill];
                [rectangle7Path fill];
                ...
                //// Text 5 Drawing
                CGRect text5Rect = CGRectMake(CGRectGetMinX(textFrame), CGRectGetMinY(textFrame) + 51, 242, 43);
                [[UIColor whiteColor] setFill];
                ...
                //// Text 3 Drawing
                CGRect text3Rect = CGRectMake(CGRectGetMinX(textFrame) + 14, CGRectGetMinY(textFrame) + 87, 216, 97);
                [color26 setFill];
                ...
                //// Text 4 Drawing
                CGRect text4Rect = CGRectMake(CGRectGetMinX(textFrame), CGRectGetMinY(textFrame), 242, 62);
                [[UIColor whiteColor] setFill];
                ...
                //// signedInLabel Drawing
                if(signedIn.length > 0) {
                CGRect signedInLabelRect = CGRectMake(CGRectGetMinX(outerFrame), CGRectGetMinY(outerFrame) + 12, 202, 31);
                [color26 setFill];
                    [signedInLabelContent drawInRect: signedInLabelRect withFont: [UIFont fontWithName: @"HelveticaNeue-Medium" size: [UIFont smallSystemFontSize]] lineBreakMode: NSLineBreakByWordWrapping alignment: NSTextAlignmentCenter];}
                
                
                //// signedInText Drawing
                CGRect signedInTextRect = CGRectMake(CGRectGetMinX(outerFrame), CGRectGetMinY(outerFrame) + 29, 202, 29);
                [color26 setFill];
...
{
    return [UIImage imageForSize:CGSizeMake(542, 624) withDrawingBlock:^
            {
                //// General Declarations
                CGColorSpaceRef colorSpace = CGColorSpaceCreateDeviceRGB();
                CGContextRef context = UIGraphicsGetCurrentContext();
                ...
                //// Rectangle Drawing
                UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRect: CGRectMake(-1, 0, 543, 425)];
                CGContextSaveGState(context);
                [rectanglePath addClip];
                CGContextDrawLinearGradient(context, gradient, CGPointMake(270.5, -0), CGPointMake(270.5, 425), 0);
                CGContextRestoreGState(context);
                
                
                //// Rectangle 7 Drawing
                UIBezierPath* rectangle7Path = [UIBezierPath bezierPathWithRect: CGRectMake(-65, 419, 654, 238)];
                [color setFill];
                [rectangle7Path fill];
